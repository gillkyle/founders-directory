...
class ContactDeck {
    let contacts = [
        ...
        Contact(name: "Leia Organa", companyName: "Rebel Alliance", phone: 3855551212, phoneUnlisted: true, email: "leia@gmail.com", emailUnlisted: true, spouseName: "Han Solo", businessProfile: "Son of rebel leader Bale Organa, fearless rebel icon known for her anti-empire views.", photoUrl: "founder2.png"),
